...
import { itemVariants, sectionContainer } from "./details/service-variants"

export function ServicesHero() {
  const scrollToOfferings = useCallback(() => {
    document
      ...
      <Container wide className="flex flex-1 flex-col items-center justify-center text-center">
        ...
        >
          ...
          >
            Explore services
            <br />
            <span className="text-[var(--text-muted)]">built to scale.</span>
          </motion.h1>
          ...
          >
            Solutions that help your brand stand out and grow — strategy,
            design, and engineering shipped as one team.
          </motion.p>
        </motion.div>
      </Container>
