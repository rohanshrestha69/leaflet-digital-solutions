      ...
      <Container wide>
        ...
        >
          ...
          <div className="mt-14 grid gap-10 md:mt-20 lg:grid-cols-2 lg:items-start lg:gap-16">
            <motion.div
              variants={itemVariants}
              className="order-2 relative aspect-[5/3] overflow-hidden rounded-[var(--radius-xl)] border border-[var(--border)] lg:order-1"
            >
              <Image
            ...
            >
              <p className="text-[16px] leading-relaxed text-[var(--text-muted)] md:text-[18px]">
                We obsess over how to design, build, and validate new ideas in
                better ways — for our partners, and for the people who
                ultimately use what we make.
              </p>
              <p className="text-[15px] leading-relaxed text-[var(--text-muted)] md:text-[16px]">
                More than 90% of our work comes through referrals. We&apos;ve
                proven, time and again, that we don&apos;t let our partners
                down. We treat every project as if our name were attached to it
                forever. It is.
              </p>
            </motion.div>
          </div>
