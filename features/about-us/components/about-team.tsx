          ...
          >
            ...
            >
              <Image
                ...
                className="object-cover transition-transform duration-700 ease-[var(--ease-premium)] hover:scale-[1.03]"
              />
              <div
                aria-hidden
            ...
            >
              ...
              <div className="my-auto flex flex-col gap-4 py-6 md:py-8">
                ...
                <p className="max-w-md text-[13px] leading-relaxed text-[var(--text-muted)] md:text-[14px]">
                  Designers, engineers, writers, and strategists across 14
                  countries — the global Leaflet network behind every project.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 border-t border-[var(--border)] pt-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <MagneticButton
                  ...
                  innerStrength={1.2}
                  className={cn(
                    "group/cta inline-flex items-center gap-1.5 rounded-full",
...
function MiniStat({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <span className="font-medium text-[9px] uppercase tracking-[0.22em] text-[var(--text-subtle)]">
        {label}
      </span>
    </div>
  )
